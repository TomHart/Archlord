...
// #endif
	...
	BOOL				m_bRefuseTrade, m_bRefusePartyIn, m_bRefuseGuildIn, m_bRefuseGuildBattle, m_bRefuseBattle, m_bDisableXP, m_bAutolootOwn;
	...
	AgcdUIUserData		*m_pstUDRefuseTrade, *m_pstUDRefusePartyIn, *m_pstUDRefuseGuildIn, *m_pstUDRefuseGuildBattle, *m_pstUDRefuseBattle, *m_pstUDDisableXP, *m_pstUDAutolootOwn;
...
// #endif
	...
	static BOOL		CBAutolootOwn(PVOID pClass, PVOID pData1, PVOID pData2, PVOID pData3, PVOID pData4, PVOID pData5, ApBase *pcsTarget, AgcdUIControl *pcsSourceControl);
