...
BOOL AgsmRide::DismountReq(AgpdCharacter* pcsAgpdCharacter, INT32 ItemID, BOOL bBySkill)
{
	...
	// 2011-09-06 silvermoo
	// 타이틀에 묶여있는 스킬을 캐스팅해 준다
	INT32 nTitleTid = pcsAgpdCharacter->m_csTitle->GetUseTitle();
	m_pcsAgsmTitle->TitleEffectCast(pcsAgpdCharacter, nTitleTid);
